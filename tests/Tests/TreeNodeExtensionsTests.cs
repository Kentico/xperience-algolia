        ...
        internal class IsIndexedByIndexTests : AlgoliaTest
        {
            ...
            public void IsIndexedByIndex_ReturnsIndexedState()
            {
                Assert.Multiple(() =>
                {
                    ...
                    Assert.That(FakeNodes.ArticleCz.IsIndexedByIndex(nameof(TestSearchModels.ArticleEnSearchModel)), Is.False);
                    ...
                    Assert.That(FakeNodes.ArticleEn.IsIndexedByIndex(nameof(TestSearchModels.OtherSiteModel)), Is.False);
                });
            }
        }
    }
